...
# UX and UI design system and guidelines

/Users/kobiagi/Desktop/Development/Product_Consultant_Helper/docs/frontend/ux-ui-design-guide.md

# design preferences

B alance these intentionally:

- Playful: micro-interactions, friendly empty states, subtle motion, warm copy.
- Professional: clean layout, strong typography, restrained color usage, consistent components.
- Beautiful: generous spacing, thoughtful composition, crisp icons, polished states.
- Easy: simple navigation, progressive disclosure, minimal cognitive load.
