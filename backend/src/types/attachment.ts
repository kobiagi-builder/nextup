 ...
 * Attachment Types
 *
 * Shared type definitions for file attachments in chat messages.
 */
...
/** Response from the process-attachment endpoint */
export interface ProcessAttachmentResponse extends ProcessedAttachment {
