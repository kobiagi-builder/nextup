 ...
 * Content Hub Page
 *
 * Lists all artifacts (Social Posts, Blogs, Showcases).
 * Features: type filtering, status filtering, search, create new.
 */
...
import { ArtifactCard, EmptyArtifacts, GridSkeleton } from '../components'
